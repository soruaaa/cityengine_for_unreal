...
void VitruvioEditorModule::StartupModule()
{
	...
	StartPIEHandle = FEditorDelegates::StartPIE.AddLambda([](bool)
	{
		VitruvioModule::Get().InvalidateAllOcclusionHandles();
	});
	
	EndPIEHandle = FEditorDelegates::EndPIE.AddLambda([](bool)
	{
		VitruvioModule::Get().InvalidateAllOcclusionHandles();
	});
